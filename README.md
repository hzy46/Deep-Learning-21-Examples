...
本工程是《21个项目玩转深度学习———基于TensorFlow的实践详解》的配套代码，代码推荐的运行环境为：Ubuntu 14.04，Python 2.7、TensorFlow >= 1.4.0。请尽量使用类UNIX系统和Python 2运行本书的代码。购买链接：[京东地址](https://item.jd.com/12327358.html)、[天猫地址](https://detail.tmall.com/item.htm?id=566399074299)。
